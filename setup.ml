...
(* OASIS_START *)
(* DO NOT EDIT (digest: a55db65916084c4d061a6338753732b4) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ngamia", []))];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ngamia"; "Ngamia_message"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "echo.ml"});
               Executable
                 ({
                     cs_name = "test_ngamia";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\208J\\\011\228\1892g\240\n\176\212K\144r\023";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
